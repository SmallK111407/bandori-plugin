...
const _cfgPath = `${_path}/plugins/bandori-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/bandori-plugin/config/`
let defSetPath = './plugins/bandori-plugin/defSet/'
